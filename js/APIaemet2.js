    ...
    .done(function(response) {
      ...
      $.ajax({
          ...
          console.log(horasFormateadas);
            ...
            const ctx = document.getElementById('api_graph2').getContext('2d');

            var Chart_api = new Chart(ctx, {
                // Tipo de gráfico
                type: 'line',
  ...
  $.ajax(settings)
    .done(function(response) {
      ...
      $.ajax({
        ...
        Chart_api.data.labels = horasFormateadas;
        Chart_api.data.datasets[0].data = temperaturas;
